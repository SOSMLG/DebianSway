...
# gparted here — already installed by 00-sway-core.sh.
# =======================================================
set -uo pipefail
...
# ---------------------------------------------------------------------------
# 1. Flatpak + Flathub — unified app source. (00-sway-core.sh also sets this
...
# ---------------------------------------------------------------------------
# 4. gparted (GUI disk tool) — already part of 00-sway-core.sh; reinstall
